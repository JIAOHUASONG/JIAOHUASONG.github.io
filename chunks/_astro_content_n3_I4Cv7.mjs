...
import { V as VALID_INPUT_FORMATS } from './config_BsBIztAW.mjs';
import { A as AstroError, L as LiveContentConfigError, i as AstroUserError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, j as renderUniqueStylesheet, k as renderScriptElement, l as createHeadAndContent, r as renderComponent } from './astro/server_DgUwLs34.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DHQP7Ccf.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://JIAOHUASONG.github.io", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_BRaItJmP.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_sswGCxDV.mjs').then(n => n._);
...
export { CONTENT_LAYER_TYPE as C, LIVE_CONTENT_TYPE as L, defineCollection as d, getCollection as g, renderEntry as r };
